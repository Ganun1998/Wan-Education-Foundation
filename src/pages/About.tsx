    ...
    <p className="text-primary-foreground/80 text-lg">
      ...
      <SectionWrapper>
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-serif font-bold mb-6">Why Wan Education Foundation Exists</h2>
          ...
          <img src={twin} alt="Classroom in South Sudan" className="rounded-lg shadow-xl w-full" />
        </div>
      </SectionWrapper>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <ul className="space-y-4">
              {[
                { title: "Community-Led", desc: "We work with, not for, communities — ensuring local ownership and sustainability." },
                { title: "Diaspora-Connected", desc: "We harness the skills, networks, and resources of the South Sudanese diaspora worldwide." },
                { title: "Evidence-Based", desc: "Every program is informed by data and continuously evaluated for impact." },
                { title: "Partner-Driven", desc: "We collaborate with schools, NGOs, UN agencies, and development partners for scale and depth." },
              ].map((item) => (
